/**
 * Created by @chaotoge on 2018/2/2.
 */
//加密解密类
...
export function publicEncrypt(data) {
  console.log(fs);
  //得到公钥
  var publicPem = fs.readFileSync(path.join(__dirname, "./pub.pem"));//替换你自己的路径
 ...
 * @returns {string}
 */
export function publicDecrypt(date) {
 ...
 * @returns {string}
 */
export function privateEncrypt(date) {
 ...
 * @returns {string}
 */
export function privateDecrypt(date) {
